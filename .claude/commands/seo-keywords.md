...
**Aux output:** `docs/seo-keywords-YYYY-MM-DD.md`
...
Из `docs/seo_mapping.md` — страницы где:
...
`docs/seo-keywords-YYYY-MM-DD.md` — таблица всех кандидатов по всем страницам, sorted by recommended.
...
Сканировать `docs/seo_mapping.md` на строки `📋 Pending approval — recommended:`.
